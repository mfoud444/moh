...
$(document).ready(function () {
    $('#button-menu').on('click', function (e) {
        ...
        $('#column-left').toggleClass('hidden');
         $('#button-menu').frist().toggleClass('hidden');
         $('#button-menu').last().toggleClass('hidden');
    });
   ...
   // Set last page opened on the menu
    ...
    if (!sessionStorage.getItem('menu')) {
        $('#menu #menu-dashboard').removeClass('bg-yellow-300');
    } else {
        // Sets active and open to selected page in the left column menu.
        $('#menu a[href=\'' + sessionStorage.getItem('menu') + '\']').parent().removeClass('bg-yellow-300');
    }
/*
