...
class __TwigTemplate_313754bd343d8a2e8e4fadd81255db4a extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<form id=\"social_media_method\">
...
// New Payment Address
\$('#social_media_method').on('submit', function (e) {
    e.preventDefault();
    ...
    chain.attach(function () {
        ...
        echo "',
            type: 'post',
            data: \$('#social_media_method').serialize(),
            dataType: 'json',
...
";
    ...
    {
        return array (  121 => 79,  85 => 46,  41 => 4,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "extension/opencart/catalog/view/template/payment/cod.twig", "/opt/lampp/htdocs/moh/upload/extension/opencart/catalog/view/template/payment/cod.twig");
    }
}
