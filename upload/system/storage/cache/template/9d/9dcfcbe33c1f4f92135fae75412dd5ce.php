...
class __TwigTemplate_f393ffdd05d3ceba878bab2797e93e56 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card\">
      ...
      <div class=\"card-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tax_class"]) {
            ...
            echo "\"";
            if ((twig_get_attribute($this->env, $this->source, $context["tax_class"], "tax_class_id", [], "any", false, false, false, 33) == ($context["shipping_flat_tax_class_id"] ?? null))) {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["geo_zone"]) {
            ...
            echo "\"";
            if ((twig_get_attribute($this->env, $this->source, $context["geo_zone"], "geo_zone_id", [], "any", false, false, false, 44) == ($context["shipping_flat_geo_zone_id"] ?? null))) {
                echo " selected=\"selected\"";
            }
            echo ">";
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <div class=\"form-check form-switch form-switch-lg\">
                ...
                <input type=\"checkbox\" name=\"shipping_flat_status\" value=\"1\" id=\"input-status\" class=\"form-check-input\"";
        // line 54
...
";
    ...
    {
        return "extension/opencart/admin/view/template/shipping/flat.twig";
    }
    ...
    {
        return new Source("", "extension/opencart/admin/view/template/shipping/flat.twig", "/opt/lampp/htdocs/moh/upload/extension/opencart/admin/view/template/shipping/flat.twig");
    }
}
