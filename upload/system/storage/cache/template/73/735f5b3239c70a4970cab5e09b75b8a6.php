...
class __TwigTemplate_96177ed4fc058399e89e94e8db9c0c02 extends Template
{
    private $source;
    private $macros = [];
...
<a  href=\"";
  ...
  <div class=\"tile-heading flex gap-4 items-center justify-between \">
    <div class=\"flex flex-row-reverse items-center gap-2 text-xl\">
      ...
      xmlns:xlink=\"http://www.w3.org/1999/xlink\" class=\"w-6 h-6\" x=\"0px\" y=\"0px\" viewBox=\"0 0 89.28 122.88\"
      style=\"enable-background:new 0 0 89.28 122.88\" xml:space=\"preserve\">
      <style type=\"text/css\">
          .st0 {
              fill-rule: evenodd;
              clip-rule: evenodd;
 ...
 <div class=\" invisible float-end bg-white px-4 py-2 rounded-full\">
 0% image.png
 </div>
    </div>
...
";
    ...
    {
        return array (  81 => 34,  75 => 31,  47 => 6,  40 => 2,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "extension/opencart/admin/view/template/dashboard/online_info.twig", "/opt/lampp/htdocs/moh/upload/extension/opencart/admin/view/template/dashboard/online_info.twig");
    }
}
