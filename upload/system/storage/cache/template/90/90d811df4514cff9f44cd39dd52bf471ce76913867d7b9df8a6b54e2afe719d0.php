...
class __TwigTemplate_5087abcdd55404f47d067b7826c3668322f8e99fa59373201b959d0d85ee4204 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<form id=\"form-shipping-method\" class=\"\">
  <fieldset>
    ...
    <div class=\"input-group my-2\">
      <select name=\"shipping_method\" id=\"input-shipping-method\" class=\"form-select\"";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["shipping_method"]) {
            ...
            ";
            // line 25
            if ( !twig_get_attribute($this->env, $this->source, $context["shipping_method"], "error", [], "any", false, false, false, 25)) {
                // line 26
                echo "              ";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["shipping_method"], "quote", [], "any", false, false, false, 26));
                foreach ($context['_seq'] as $context["_key"] => $context["quote"]) {
                    ...
                    echo ">";
                    echo twig_get_attribute($this->env, $this->source, $context["quote"], "title", [], "any", false, false, false, 27);
                    if (twig_get_attribute($this->env, $this->source, $context["quote"], "cost", [], "any", false, false, false, 27)) {
                        echo " (+";
              ...
              ";
                ...
                echo twig_get_attribute($this->env, $this->source, $context["shipping_method"], "error", [], "any", false, false, false, 30);
                echo "</option>
            ";
            }
            // line 32
...
";
    ...
    {
        return array (  216 => 120,  197 => 104,  161 => 71,  141 => 54,  119 => 34,  112 => 32,  106 => 30,  103 => 29,  83 => 27,  78 => 26,  76 => 25,  73 => 24,  69 => 23,  62 => 21,  42 => 4,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "catalog/view/template/checkout/shipping_method.twig", "/opt/lampp/htdocs/moh/upload/catalog/view/template/checkout/shipping_method.twig");
    }
}
