...
class __TwigTemplate_d4c2a7a7ac628e0a6bc2e28827e06faf extends Template
{
    private $source;
    private $macros = [];
    ...
    <tbody>
      ";
        ...
        if (($context["products"] ?? null)) {
            ...
            <td class=\"text-end\">";
                // line 17
                echo twig_get_attribute($this->env, $this->source, $context["product"], "viewed", [], "any", false, false, false, 17);
                echo "</td>
            <td class=\"text-end\">";
                // line 18
                echo twig_get_attribute($this->env, $this->source, $context["product"], "percent", [], "any", false, false, false, 18);
                echo "</td>
          </tr>
        ";
            }
...
<div class=\"row\">
  ...
  <div class=\"col-sm-6 text-end\">";
    ...
    {
        return new Source("", "extension/opencart/admin/view/template/report/product_viewed_list.twig", "/opt/lampp/htdocs/moh/upload/extension/opencart/admin/view/template/report/product_viewed_list.twig");
    }
}
