...
class __TwigTemplate_241e9684c7f06b015f6c567402d3b214 extends Template
{
    private $source;
    private $macros = [];
...
$context["product"], "quantity", [], "any", false, false, false, 39) <= 5)) {
              ...
              <td class=\"text-end\">
                ...
                if (twig_get_attribute($this->env, $this->source, $context["product"], "variant", [], "any", false, false, false, 45)) {
                    ...
                    <button hidden type=\"button\" class=\"btn btn-primary dropdown-toggle dropdown-toggle-split\" data-bs-toggle=\"dropdown\"><i class=\"fa-solid fa-caret-down\"></i></button>
...
";
    ...
    {
        return new Source("", "admin/view/template/catalog/product_list.twig", "/opt/lampp/htdocs/moh/upload/admin/view/template/catalog/product_list.twig");
    }
}
