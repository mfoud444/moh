...
$_['error_upload_size']     = 'تحذير: الملف الذي تم تحميله يتجاوز الـe %smb الحد الأقصى لحجم الملف !';
$_['error_curl']            = 'CURL: رمز الخطأ (%s): %s';
$_['error_session']         = 'تحذير: انتهت الجلسة ، يرجى إرسال النموذج مرة أخرى !';
